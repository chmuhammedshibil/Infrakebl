...
const page = () => {
  ...
  return (
    <NetBandLayout menus={menus} single>
      {/*<< Hero Section Start >>*/}
      <Home2 />
      {/*<< Service Section Start >>*/}
      <section className="service-section-2 fix section-padding" id="services">
      ...
      <section className="pricing-section-2 fix section-padding" id="pricing">
        <div className="container">
